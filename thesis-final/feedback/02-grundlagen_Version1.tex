...
Im Beispielszenario wird zunächst $P1$ ausgeführt. Nach Ablauf des Quantums werden bereite Tasks in Warteschlangenreihenfolge berücksichtigt. Die Visualisierung muss deshalb Quantumablauf, Wiedereinreihung und Taskwechsel sichtbar machen.
...
Stallings sowie Tanenbaum und Bos behandeln Betriebssysteme, Prozesse und Scheduling, setzen aber unterschiedliche Akzente. Die Werke werden in dieser Arbeit nicht als widersprüchliche Theorien gegenübergestellt, sondern als sich ergänzende Zugänge verwendet.
