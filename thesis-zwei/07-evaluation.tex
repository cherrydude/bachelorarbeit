...
Der typische Nutzerfluss beginnt mit dem Definieren eines Szenarios. Auf der Startseite sind die Systemgrundlagen, die Eingabeform und die Auswahl relevanter Task-Parameter direkt sichtbar. Nach dem Laden eines Szenarios kann der Nutzer den gewünschten Algorithmus auswählen und den Ablauf in verschiedenen Modi starten. Anschließend stehen eine Fokusansicht und eine Vergleichsübersicht zur Verfügung.
...
\begin{figure}[htbp]
    ...
    \caption{Ladezustand eines konfigurierten Szenarios. Die Task-Daten sind sichtbar, und die Simulation kann mit einer klaren Ablaufsteuerung initialisiert werden.}
...
\begin{figure}[htbp]
    ...
    \caption{Fokusansicht der Simulation mit Gantt-Zeitachse, aktiver Task-Darstellung und Kennzahlbereich. Diese Ansicht zeigt den Ablauf des gewählten Scheduling-Verfahrens in einer verständlichen, zeitlich strukturierten Form.}
...
\begin{figure}[htbp]
    ...
    \caption{Detailansicht der Gantt-Darstellung. Einzelne Ausführungssegmente, Präemptionen und Task-Wechsel werden als konkrete Zeitabschnitte sichtbar gemacht.}
...
\begin{figure}[htbp]
    ...
    \caption{Darstellung des Task-Status in der Warteschlangenansicht. Der aktuelle Zustand und die Warteliste werden gleichzeitig präsentiert, wodurch die Auswahlentscheidung des Algorithmus nachvollziehbar wird.}
...
\begin{itemize}
    \item Erstellung und Bearbeitung von Task-Daten mit Ankunftszeit, Burst-Zeit und Priorität,
