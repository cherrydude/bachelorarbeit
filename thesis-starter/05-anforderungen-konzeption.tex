...
Aus fachlicher Sicht muss der Visualizer die betrachteten Verfahren konsistent und korrekt modellieren. Dazu gehoeren insbesondere LCFS, Round Robin, Strict Priority und MLFQ. Relevante Kernaspekte sind Ankunftszeit, Burst-Zeit, Prioritaet, Zeitquantum, Praeemption und Kontextwechsel \cite{silberschatz2018operating,tanenbaum2014modern}.
...
\begin{itemize}
	\item \textbf{Transparenz der Zustandsuebergaenge:} Ereignisse wie Start, Praeemption und Abschluss muessen nachvollziehbar dargestellt werden.
...
Konzeptionell werden dabei zwei Anforderungen verbunden: erstens fachliche Korrektheit der Scheduling-Regeln, zweitens auswertbare Verlaufsdaten fuer Visualisierung und Evaluation. Das Ereignismodell muss daher nicht nur Endergebnisse liefern, sondern auch Zwischenschritte explizit protokollieren, damit Praeemptionen und Kontextwechsel analytisch nachvollzogen werden koennen \cite{silberschatz2018operating,pinedo2016scheduling}.
