...
Round Robin wird ueber ein Zeitquantum modelliert, Strict Priority ueber prioritaetsbasierte Auswahl inklusive Praeemption bei hoeherrangigen Ankuenften, LCFS ueber last-in-first-out-Mechanik und MLFQ ueber mehrere Warteschlangenebenen mit regelbasierter Herabstufung. Damit wird die in der Literatur beschriebene algorithmische Charakteristik im Kern einheitlich und vergleichbar operationalisiert \cite{silberschatz2018operating,tanenbaum2014modern,pinedo2016scheduling}.
...
Eine zentrale Herausforderung bestand in der Synchronisation von Simulationsgenauigkeit und interaktiver Bedienung. Einerseits musste die fachliche Korrektheit bei Praeemption, Kontextwechsel und MLFQ-Regelwerk sichergestellt werden, andererseits sollte die Anwendung unmittelbar auf Eingaben reagieren.
